...
- Clone the project inside a folder named `"object_detection"` inside subsystem  root of USERNAME folder (refer to the project structure above): https://github.com/faa2025/ai-security-camera-object-detection
